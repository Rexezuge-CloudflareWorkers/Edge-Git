...
- `FetchHandler` / `PushHandler` — pack fetch/push protocol handling inside the DO; `ReadModelService` — branches/tree/blob/commits reads served to the API passthroughs.
